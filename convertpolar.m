function histo = convertpolar(pic,center,Nsectors)
%this code is essentially the same as radial_lineoutVer3P
...
Rmax=ceil(min([dimy-center(1) center(1) dimx-center(2) center(2)]));
