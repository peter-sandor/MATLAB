...
% *******************************************
function output = SFI_1plus1(input)
...
Up=9.33*params.I_REF/1e18*(300/(input.nu_field))^2; % ponderomotive shift at the reference intensity in [eV]
nu_Up=Up*1.6e-19/6.626e-34/1e12; % in [THz]

% C: Levels
params.w0 = 0; %Peak AC Stark shift of level |0>, [radian/ps]
params.w1 = 1*2*pi*nu_Up; %Peak AC Stark shift of level |1>
params.w3 = 1*2*pi*nu_Up; %Peak AC Start shift of level |3>
params.wC = 1*2*pi*nu_Up; %Peak AC Stark shift of Continuum 
% An AC Stark shift of the continuum of 180 THz corresponds to Up=0.745 eV
% which corresponds to a peak intensity of 12.78 TW/cm^2 at 790 nm.
...
params.w01 = 2*pi*370;
params.w03 = 2*pi*30 + params.w01;
params.w0C3 = 2*pi*700 + params.EMAX/params.HBAR/2*1E-12;
params.w0C1 = 2*pi*670 + params.EMAX/params.HBAR/2*1E-12;
...
params.rabi0C1 = 0*2*pi*10;
params.rabi01 = 1*2*pi*1;
params.rabi1C1 = 1*2*pi*50;

params.rabi0C3 = 0*2*pi*3;
params.rabi03 = 0*2*pi*10;
params.rabi3C3 = 0*2*pi*10;

params.coupling13 = 0*2*pi*15; % Nonadiabatic coupling between 1 and 3
