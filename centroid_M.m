...
% usage: coords_out = centroid_M
%                   in this case the image to be read in is chosen from a dialog, and a
...
radius=2;
minlistlength=4;
filtersize=60; % 60 for 360x360
max_coord_diff=30; % 30 for 360x360
